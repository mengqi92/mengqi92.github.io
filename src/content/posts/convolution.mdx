...
tags:
  ...
  - Gabor 特征
category: 图像处理
description: 在学习机器学习和图像处理的过程中，经常会遇到卷积这个概念。我每次遇到这个概念都有点似懂非懂的样子。有时候清楚它的直观解释，但又搞不清公式中是如何体现的。究其原因，还是我没有完全搞懂这个概念。 维基百科上有一个动态图来演示这个概念，但对于我来说还是有些复杂。于是自己在网上找了很多文章来研究，终于有了比较直观的印象，这里就趁热把我理解的解释一下，作为总结。
coverImage: https://blog.mengqi.life/images/convolution/banner.jpeg
math: true

createdDate: 2015-10-06 20:05:00
modifiedDate: 2015-10-06 20:05:00
---
...
![药效持续函数](https://blog.mengqi.life/images/convolution/conv-effect-function.png)
...
![第一天累积的药效示意](https://blog.mengqi.life/images/convolution/conv-effect-day1.png)
...
![第二天累积的药效示意](https://blog.mengqi.life/images/convolution/conv-effect-day2.png)
...
![第三天累积的药效示意](https://blog.mengqi.life/images/convolution/conv-effect-day3.png)
...
![二维卷积示例](https://blog.mengqi.life/images/convolution/2d-convolution.png)
...
3. [Understanding Convolution（用图和例子从一维卷积一直讲到了CNN）](https://colah.github.io/posts/2014-07-Understanding-Convolutions)
