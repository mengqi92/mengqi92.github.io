...
coverImage: https://blog.mengqi.life/images/linear-algebra-3/banner.jpeg
math: true
createdDate: 2016-05-20 21:11:00
modifiedDate: 2016-05-20 21:11:00
---

[上一章](/posts/linear-algebra-2)我们讨论了齐次和非齐次两种线性方程组的解集，以及它们的几何意义。由齐次线性方程组，我们引入了零空间的概念；而由非齐次线性方程组，我们引入了列空间的概念。这两个空间目前是我们理解线性方程组的桥梁，未来还会对这些空间进行更进一步的讨论。在这之前，让我们先来研究一下矩阵的意义。 
...
![变换$T$](https://blog.mengqi.life/images/linear-algebra-3/linear-transformation.png)
...
![旋转变换](https://blog.mengqi.life/images/linear-algebra-3/rotation.png)
...
![满射](https://blog.mengqi.life/images/linear-algebra-3/existence.png)
...
![一对一映射](https://blog.mengqi.life/images/linear-algebra-3/uniqueness.png)
