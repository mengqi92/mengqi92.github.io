...
coverImage: https://blog.999622.xyz/images/gabor/banner.jpeg
math: true
...
![二维高斯](https://blog.999622.xyz/images/gabor/2d-gaussian.png)
...
![Gabor 核频率域图示](https://blog.999622.xyz/images/gabor/gabor-filter-frequency.png)
...
![Gabor 核空间域图示](https://blog.999622.xyz/images/gabor/gabor-filter-spatial.png)
...
通过上面的分析，我们知道了，一个Gabor核能获取到图像某个频率邻域的响应情况，这个响应结果可以看做是图像的一个特征。那么，我们如果用多个不同频率的Gabor核去获取图像在不同频率邻域的响应情况，最后就能形成图像在各个频率段的特征，这个特征就可以描述图像的频率信息了
 ...
 ![ 一系列 Gabor 核](https://blog.999622.xyz/images/gabor/gabor-filter-banks.png)
