...
description: 研究傅里叶变换的过程中经常要和复数打交道，经常会遇到 $e^{ix}$ 这种形式。这里就总结一下复数的直角坐标、极坐标，以及复指数表示形式，也有对欧拉公式的直观解释，以便更好地理解傅里叶变换。

createdDate: "2015-10-06T14:47:16.000Z"
modifiedDate: "2015-10-06T14:47:16.000Z"
...
本文中图片均来自于 [国立台湾师范大学资讯工程学系的演算法笔记](https://web.ntnu.edu.tw/~algo/Wave.html)。
...
![复平面](https://blog.mengqi.life/images/complex/complex-plane.webp)
...
![复数的极坐标表示](https://blog.mengqi.life/images/complex/complex-polar-plane.webp)
...
![复数两种表示形式之间的转换 ](https://blog.mengqi.life/images/complex/complex-polar-transform.webp)
...
![实数波和复数波示意 ](https://blog.mengqi.life/images/complex/real-wave-complex-wave.webp)
...
### 参考资料：
1. [国立台湾师范大学资讯工程学系的演算法笔记](https://web.ntnu.edu.tw/~algo/Wave.html)
