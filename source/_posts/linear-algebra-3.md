...
{% image https://d1aeqfcn0xwy4s.cloudfront.net/images/linear-algebra-3/banner.jpeg %}
...
{% image https://d1aeqfcn0xwy4s.cloudfront.net/images/linear-algebra-3/linear-transformation.png 变换$T$ %}
...
{% image https://d1aeqfcn0xwy4s.cloudfront.net/images/linear-algebra-3/rotation.png 旋转变换 %}
...
{% image https://d1aeqfcn0xwy4s.cloudfront.net/images/linear-algebra-3/existence.png 满射 %}
...
{% image https://d1aeqfcn0xwy4s.cloudfront.net/images/linear-algebra-3/uniqueness.png 一对一映射 %}
