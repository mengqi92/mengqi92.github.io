...
{% image https://mengqistatic.azureedge.net/staticfiles/think-statistics-note/pmf-cdf-pdf.jpg 分布函数的关系框架 %}
...
{% image https://mengqistatic.azureedge.net/staticfiles/think-statistics-note/nonlinear-correlation-example.png 非线性关系变量散点图及其相关系数 %}
